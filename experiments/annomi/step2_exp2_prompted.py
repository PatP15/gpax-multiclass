...
def main():
    print("=== Step 2: Experiment 2 (Context - Prompted) ===")
    ...
    res['Scenario'] = 'Context (Prompted)'
    
    # Save Results
    save_path = os.path.join(common.RESULTS_DIR, 'results_exp2_prompted.csv')
    res.to_csv(save_path, index=False)
    print(f"Saved results to {save_path}")

    # Save Raw Data
    raw_path = os.path.join(common.DATA_DIR, 'raw_exp2_prompted.npz')
    save_dict = {}
