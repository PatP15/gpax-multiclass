...
def main():
    print("=== Step 2: Experiment 4 (Context + Quality) ===")
    ...
    res['Scenario'] = 'Context + Quality'
    
    # Save Results
    save_path = os.path.join(common.RESULTS_DIR, 'results_exp4_quality.csv')
    res.to_csv(save_path, index=False)
    print(f"Saved results to {save_path}")

    # Save Raw Data
    raw_path = os.path.join(common.DATA_DIR, 'raw_exp4_quality.npz')
    save_dict = {}
